<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
    ...
    <div>
        ...
        <input v-model="bookData.finishedReading" type="checkbox" name="" id="">
    </div>
    <div>
        <label for="borrowed">borrowed</label>
        <input type="radio" v-model="bookData.ownership" name="" id="" value="borrowed">
        <label for="bought">bought</label>
        <input type="radio" v-model="bookData.ownership" name="" id="" value="bought">
    </div>
